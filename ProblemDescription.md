...
One solution to dead ends and spider traps is for the random surfer :surfer: to have a small probability, 1-$\beta$ of teleporting rather than follow the outlink from the current page.
